...
function displayGuessFeedback(guess){
    guessDiv = document.getElementById("guesses"); //feedback on input
    ...
    guessDiv.append(newDiv);

}

// setTimeout(() => {
//     displayGuessFeedback('hello')
// },500); //arrow syntax defines function

userInp = document.getElementById("guess-inp");
// console.log(userInput.value);
// setTimeout(displayGuessFeedback('hello'),500); //calls it right away 
...
function onSubmit() {
    ...
    inpval = userInp.value.toUpperCase();
    ...
    if (inpval.length != WORD_LENGTH){
        ...
        if (inpval === correctAnswer.toUpperCase()){
...
//--------------------------------------------------------------------------------------
    // console.log("in displayGuessFeedback")
